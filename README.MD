...
## 🔌 Command Sample
```js
// This all project is based on telebot so please read documentation and working function of the package.
const axios = require('axios'); // importing module
module.exports = {
    config: {
        name: 'example', // command name
        aliases: ['eg'], //alternative names i.e alias
        category: 'example', // Command category
        role: 0, // 0 = all users, 1 = group admin and 2 = bot admin
        cooldowns: 5, // Cooldowns to avoid heavy spam and RAM consumption
        version: '1.0.0', // Command version
        author: 'Samir Thakuri', // Author of the command
        description: 'desc', // Detailed description of command
        usage: '/example' // Steps to use commands
    },

    onStart: async function({ bot, msg, args, chatId, userId, config, botName, copyrightMark, senderName }) {
        //Command logic and working functions
    }
};
